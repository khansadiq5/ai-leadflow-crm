    ...
    <div class="max-w-3xl mx-auto">
        <div class="rounded-[1.5rem] border border-red-100 bg-red-50 px-6 py-6 text-red-700">
            ...
            <p class="mt-2 text-sm leading-6">
                Sales Executive cannot create tasks. You can only view your assigned tasks and update their status.
            </p>
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div>
            ...
            <p class="text-slate-500 mt-2">
                Create a follow-up, reminder, call task or sales activity for your CRM team.
            </p>
        </div>
    ...
    <form method="POST" action="{{ route('tasks.store') }}" class="space-y-6">
        ...
        <div class="rounded-[1.5rem] border border-white/70 bg-white/75 backdrop-blur px-5 sm:px-6 py-6 shadow-sm">
            <div class="mb-6">
                ...
                <p class="text-sm text-slate-500 mt-1">
                    Add task title, deadline, priority and current status.
                </p>
            </div>
        ...
        <div class="rounded-[1.5rem] border border-white/70 bg-white/75 backdrop-blur px-5 sm:px-6 py-6 shadow-sm">
            <div class="mb-6">
                ...
                <p class="text-sm text-slate-500 mt-1">
                    Link this task with a lead, customer or deal if needed.
                </p>
            </div>
        ...
        <div class="rounded-[1.5rem] border border-white/70 bg-white/75 backdrop-blur px-5 sm:px-6 py-6 shadow-sm">
            <div class="mb-6">
                ...
                <p class="text-sm text-slate-500 mt-1">
                    Add task details, call notes, reminder message or internal instructions.
                </p>
            </div>
