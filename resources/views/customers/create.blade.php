    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div>
            ...
            <p class="text-slate-500 mt-2">
                Create a customer profile, add contact details and assign it to your CRM team.
            </p>
        </div>
    ...
    <form method="POST" action="{{ route('customers.store') }}" class="space-y-6">
        ...
        <div class="rounded-[1.5rem] border border-white/70 bg-white/75 backdrop-blur px-5 sm:px-6 py-6 shadow-sm">
            <div class="mb-6">
                ...
                <p class="text-sm text-slate-500 mt-1">
                    Add the primary customer contact details.
                </p>
            </div>
        ...
        <div class="rounded-[1.5rem] border border-white/70 bg-white/75 backdrop-blur px-5 sm:px-6 py-6 shadow-sm">
            <div class="mb-6">
                ...
                <p class="text-sm text-slate-500 mt-1">
                    Add customer location and address information.
                </p>
            </div>
        ...
        <div class="rounded-[1.5rem] border border-white/70 bg-white/75 backdrop-blur px-5 sm:px-6 py-6 shadow-sm">
            <div class="mb-6">
                ...
                <p class="text-sm text-slate-500 mt-1">
                    Set customer type, account status and team ownership.
                </p>
            </div>
                ...
                <div>
                    ...
                    >
                        @foreach(['individual','company','vip','regular'] as $type)
                            <option value="{{ $type }}" {{ old('type', 'regular') == $type ? 'selected' : '' }}>
                                {{ ucfirst($type) }}
                            </option>
                        @endforeach
                    </select>
        ...
        <div class="rounded-[1.5rem] border border-white/70 bg-white/75 backdrop-blur px-5 sm:px-6 py-6 shadow-sm">
            <div class="mb-6">
                ...
                <p class="text-sm text-slate-500 mt-1">
                    Add customer requirements, preferences or internal CRM notes.
                </p>
            </div>
